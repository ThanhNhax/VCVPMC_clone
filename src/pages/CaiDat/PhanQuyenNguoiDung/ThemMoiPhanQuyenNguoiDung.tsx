        ...
        <div className="ThemMoiPhanQuyenNguoiDung">
            <div className="container">
                <div className="container-top">
                    <p>
                        Thêm người dùng mới
                        <i className="fas fa-chevron-right"></i>Phân quyền người
                        dùng<i className="fas fa-chevron-right"></i>Thêm người
                        dùng
                    </p>
                ...
                <div className="container-form">
                    <Formik
                        ...
                        onSubmit={(value) => {
                            ...
                            try {
                                addDoc(
                                    collection(db, 'phanQuyenNguoidDung'),
                                    value
                                );
                                message.open({
                                    type: 'success',
                        ...
                        {({ errors, touched }) => (
                            <Form>
                                    ...
                                    <div className="wrap-form">
                                        ...
                                        <div className="form-group">
                                            ...
                                            >
                                                ...
                                                <option value="Group Admin">
                                                    Group Admin
                                                </option>
                                                <option value="Sub - user">
                                                    Sub - user
                                                </option>
                                ...
                                <div className="form-btn">
                                    <p>
                                        <i>*</i>là những trường thông tin bắt
                                        buộc
                                    </p>
                                    <div className="btn">
                                        <button
