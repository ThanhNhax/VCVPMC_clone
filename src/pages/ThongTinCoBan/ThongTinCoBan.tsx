                                ...
                                <div className="form-title">
                                    ...
                                    <div className="password">
                                        <Field
                                            ...
                                            className={
                                                errors.passwordHienTai &&
                                                touched.passwordHienTai
                                                    ? 'input-error'
                                                    : ''
                                            }
                                        />
                                ...
                                <div className="form-title">
                                    ...
                                    <div className="password">
                                        <Field
                                            ...
                                            className={
                                                errors.passwordNhapLai &&
                                                touched.passwordNhapLai
                                                    ? 'input-error'
                                                    : ''
                                            }
                                        />
